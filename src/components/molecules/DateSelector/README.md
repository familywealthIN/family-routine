...
```css
.period-toggle-container  /* Period buttons background */
.period-toggle            /* Period toggle layout */
.year-title               /* Year/decade display in navigation */
.week-list                /* Scrollable week list */
.month-grid               /* Month button grid (3 columns) */
.year-grid                /* Year button grid (3 columns) */
.lifetime-selector        /* Lifetime period display */
```
