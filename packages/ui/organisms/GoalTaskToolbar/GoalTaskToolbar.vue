...
export default {
  ...
  props: {
    ...
    // Whether the parent goal item is already flagged as a milestone.
    // The "Milestone of" selector stays visible on edit even if the
    // toolbar's other criteria (showMilestoneOption) aren't satisfied
    // yet — otherwise users couldn't see / change the existing parent.
    isMilestone: {
      type: Boolean,
      default: false,
    },
