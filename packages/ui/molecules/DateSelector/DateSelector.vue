...
export default {
  ...
  props: {
     ...
     * `''` is allowed because the shared defaultGoalItem starts with an
     * empty period — the user hasn't picked one yet — and we don't want
     * to surface a Vue prop-validator warning for the legitimate
     * "unset" state.
     */
    period: {
      type: String,
