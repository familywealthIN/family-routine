...
<template>
  <container-box :isLoading="isLoading || isAuthenticatedSignIn">
    <h2 class="text-xs-center pt-4">Build Your Routine</h2>
    <div class="banner-box">
      <img src="/img/login-banner.png" alt="Login Banner" />
    </div>
    <h2 class="text-xs-center pt-3">Set Progressive Goals</h2>
    <p class="text-xs-center pt-2 pl-3 pr-3 text-muted">
      Build a harmony between your routine and goals to live a prosperous
      healthy life.
    </p>
    <div class="login-box">
      <a
      ...
      >
        ...
        <div class="g-text">Sign in with Google</div>
      </a>
      <a
        href="javascript:void(0)"
        class="apple-button"
      ...
      >
        ...
        <div class="apple-text">Sign in with Apple</div>
      </a>
    </div>
    <!-- <footer> -->
    <div class="text-xs-center text-muted pb-3">
      <small>
        By using Routine Notes, you accept our
...
export default {
        ...
        try {
          ...
          if (platform === 'ios') {
            ...
            await GoogleAuth.initialize({
              ...
              scopes: ['profile', 'email'],
              grantOfflineAccess: true,
              androidClientId: gauthOption.androidClientId,
              iosClientId: gauthOption.iosClientId,
              webClientId: gauthOption.clientId,
              forceCodeForRefreshToken: true,
            });
          }
          ...
          const notificationId =
            localStorage.getItem(GC_NOTIFICATION_TOKEN) || '';
  ...
  mounted() {
    ...
    const checkGauthLoad = setInterval(() => {
      ...
      this.isSignIn = this.isNative
        ? !!token
        : this.$gAuth.isAuthorized && !window.appSignedOut;
